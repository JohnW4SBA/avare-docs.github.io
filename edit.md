...
3. Use the above link to find and click the filename to open the item you'd like to edit in a new tab, keeping this page open for reference. A great first edit is this "quick steps" section of the [edit.md](https://github.com/avare-docs/avare-docs.github.io/blob/main/edit.md) file you're reading, because you can help make editing easier for others to learn. Just click that **filename** and then the "**Pencil**" icon near the right end of the title bar with the number of lines, file size (kb), "Raw" button, etc.
